...
if __name__ == '__main__':
    ...
    print("[Init] loading MaskFlowNet from:", par.pretrained_flownet_path)
    print("[Init] number of tensors from flownet ckpt:", len(pretrained_dict))
    print("[Init] any non-encoder keys loaded?:",
      any((not k.startswith("encoder.maskflownet.")) for k in pretrained_dict.keys()))
